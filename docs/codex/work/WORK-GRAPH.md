...
| TASK-142 | task | blocked | x402 merchant, payment adapter | Real x402 route verifies payment. | Real payment evidence. | Merchant candidate found; rotate/reissue secrets, fund, then test after approval. |
...
| TASK-152 | task | blocked | GOAT mainnet, 8004scan | ClawCompass appears on 8004scan. | Mainnet tx and URL. | Requires verified wallet/gas/approval and address-role clarification. |
